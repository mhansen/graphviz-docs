...
*   [idot](http://code.google.com/p/idot/) (2010), an incremental Graphviz viewer (Java ≥ 1.5 with the excellent [prefuse](http://prefuse.org/) toolkit). \[Mikko Vinni\]
...
*   [QuikGraph](https://github.com/KeRNeLith/QuikGraph) \- Generic Graph Data Structures and Algorithms for .NET
