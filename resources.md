...
<li><a href="https://github.com/eclipse/gef/wiki/DOT-User-Guide">Eclipse GEF DOT</a>, an Eclipse plugin that can be used to render and edit DOT graphs within Eclipse. For further information watch the <a href="https://www.youtube.com/watch?v=GnSVLNYfGlk">recorded GEF DOT session</a> on the EclipseCon Europe 2018. [Fabian Steeg, Michael Clay, Alexander Nyssen, Matthias Wienand, Tamas Miklossy]</li>
